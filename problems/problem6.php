...
'name' => 'おともだち',
'point' => 100,
'answer_query' => 'a.from_id, a.to_id from followings as a inner join followings as b on a.from_id=b.to_id and a.to_id=b.from_id order by from_id, to_id;',
'sample' => 'a.from_id, a.to_id from followings as a inner join followings as b on a.from_id=b.to_id and a.to_id=b.from_id order by from_id, to_id;',
];