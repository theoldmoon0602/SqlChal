...
依頼の内容は、ユーザ id が 496 の人にフォローされているユーザのツイートを、時刻に降順に並べて取得することです。',
    'text' => 'ユーザid <code>users.id</code>が496であるユーザのタイムライン（そのユーザにフォローされているユーザのツイート内容（<code>tweets.content</code>）を時刻（ <code>tweeets.created_at</code> ）に昇順に並べたもの）を表示してください。',
